...
def get_emergency_response(text):
    ...
    if any(
        keyword in text_lower for keyword in ["chest pain", "heart attack", "cardiac"]
    ):
        return (
    ...
    if any(
        ...
        for keyword in ["stroke", "face drooping", "arm weakness", "speech difficulty"]
    ):
        return (
    ...
    if any(
        keyword in text_lower
        for keyword in ["breathing", "breathe", "suffocating", "choking"]
    ):
        return (
    ...
    if any(
        keyword in text_lower
        for keyword in ["suicide", "kill myself", "end my life", "don't want to live"]
    ):
        return (
