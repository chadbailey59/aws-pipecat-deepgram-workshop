...
def weather(lat, lon: float) -> str:
    ...
    params = {"latitude": str(lat), "longitude": str(lon), "current_weather": True}
...
class StrandsAgent:
    def __init__(self):
        ...
        self.aws_location_srv_client = MCPClient(
            lambda: stdio_client(
        ...
        bedrock_model = BedrockModel(
            model_id="amazon.nova-lite-v1:0", boto_session=session
        )
